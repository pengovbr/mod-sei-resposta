...
/**
 * Atualizador abstrato para sistema do SEI para instalar/atualizar o módulo RESPOSTA
 *
 *
 */
abstract class MdRespostaVersaoRN extends InfraRN {

    protected $sei_versao;

    /**
     * @var string Versão mínima requirida pelo sistema para instalação do RESPOSTA
     */
  ...
  protected function inicializarObjMetaBanco() {
    if (empty($this->objMeta)) {
        $this->objMeta = new MdMetaBD($this->inicializarObjInfraIBanco());
    }
      return $this->objMeta;
  }
