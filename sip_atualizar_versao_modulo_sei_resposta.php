...
class ModuloRespostaVersaoSipRN extends InfraRN {
	...
	private function instalarv001(){
		...
		//SEI ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$this->logar('ATUALIZANDO RECURSOS, MENUS E PERFIS DO MÓDULO DE RESPOSTA - GOV.BR NA BASE DO SIP...');
		...
		$objItemMenuDTOControleProcesso = $this->adicionarItemMenu($numIdSistemaSei, 
				...
				null, 
				'Módulo de Resposta - Gov.br',
				'Configuração dos Parametros Gerais do Módulo',
				0);
		
		//criando Módulo de Resposta - Gov.br -> Parâmetros de Configuração
