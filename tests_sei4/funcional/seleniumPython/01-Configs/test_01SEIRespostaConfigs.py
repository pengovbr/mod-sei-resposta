...
class Test01SEIRespostaConfigs():
  ...
  def test_00ConfigValidacaoSistema(self):
    ...
    time.sleep(5)
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.XPATH, "//*[text()=\"Parâmetros de Configuração\"]")))
    self.driver.find_element(By.XPATH, "//*[text()=\"Parâmetros de Configuração\"]").click()
