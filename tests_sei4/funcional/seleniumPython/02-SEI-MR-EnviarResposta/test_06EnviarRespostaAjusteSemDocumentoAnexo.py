...
class Test02SEIMREnviarResposta():
  ...
  def test_06EnviarRespostaAjusteSemDocumentoAnexo(self):
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.visibility_of_element_located((By.ID, "txaMensagem")))
    ...
    elements = self.driver.find_elements(By.XPATH, "//img[@alt=\'Enviar Resposta\']")
    assert len(elements) == 0