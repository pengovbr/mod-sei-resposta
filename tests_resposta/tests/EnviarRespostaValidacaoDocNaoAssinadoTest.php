 ...
 *  - testEnviarRespostaValidacaoDocNaoAssinado: executa o cenario de UI (Selenium) e valida que o
 *    envio da resposta com um documento incluido, porem nao assinado, exibe o alerta
...
XML;
    ...
    /**
     * Etapa 2: cenario de validacao do envio com documento nao assinado.
     * Equivalente ao metodo Python test_04EnviarRespostaValidacaoDocNAssinado (linha 92 em diante).
     *
    ...
    public function testEnviarRespostaValidacaoDocNaoAssinado($procedimentoFormatado)
    {
        ...
        // Salvar abre a janela do editor; fecha-se a janela sem editar o conteudo (documento nao assinado)
