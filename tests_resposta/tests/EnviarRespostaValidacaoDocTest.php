 ...
 *  - testEnviarRespostaValidacaoDoc: executa o cenario de UI (Selenium) e valida que o envio da
 *    resposta em um processo sem documentos exibe o alerta "Nao ha documento(s) no processo.".
 */
...
XML;
    ...
    /**
     * Etapa 2: cenario de validacao da existencia de documentos no envio da resposta.
     * Equivalente ao metodo Python test_03EnviarRespostaValidacaoDoc (linha 92 em diante).
     *
