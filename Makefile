...
MENSAGEM_AVISO_MODULO = $(RED)[ATEN��O]:$(NC)$(YELLOW) Necess�rio configurar a chave de configura��o do m�dulo no arquivo de configura��o do SEI (ConfiguracaoSEI.php) e prover o modulo na pasta correta $(NC)\n               $(YELLOW)'Modulos' => array('MdRespostaIntegracao' => 'mod-sei-resposta') $(NC)
MENSAGEM_AVISO_ENV = $(RED)[ATEN��O]:$(NC)$(YELLOW) Configurar par�metros de autentica��o do ambiente de testes do m�dulo de Resposta no arquivo .modulo.env $(NC)
...
dist: cria_json_compatibilidade
	...
	@echo "Constru��o do pacote de distribui��o finalizada com sucesso"
...
clean:
	@rm -rf dist
	@echo "Limpeza do diret�rio de distribui��o do realizada com sucesso"
...
install: prerequisites-modulo-instalar
	...
	@echo "==================================================================================================="
	@echo ""
	@echo "Fim da instala��o do m�dulo"
